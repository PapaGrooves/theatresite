...
// Comment this out when you are finished with the website.
    ...
    // for use on laptop
    // define('ROOT_DIR', 'http://localhost:8040/theatresite/');
    // define('AUTH_DIR', 'http://localhost:8040//theatresite/account/dashboard/');
// for use on college pc in room 13
    define('ROOT_DIR', 'http://localhost/projects/theatresite/');
    define('AUTH_DIR', 'http://localhost/projects/theatresite/account/dashboard/');
?>
<!doctype html>
<html lang="en">
<head>
