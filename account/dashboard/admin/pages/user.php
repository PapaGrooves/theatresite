...
<!--table of users  -->
  ...
  <section class="bg-gray-900 pb-5">
  <div class="container w-full md:w-4/5  mx-auto px-2">

		<!--Title-->
	
    <h1 class="text-slate-50 p-5">ALL USERS</h1>  


		<!--Card-->
		<div id='recipients' class="p-8 mb-8 mt-6 lg:mt-0 rounded shadow bg-white">
    <button onclick="window.location.href='./addUser.php';" class="bg-red-700 text-white active:bg-pink-600 font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md hover:bg-gray-700 outline-none focus:outline-none mr-1 ease-linear transition-all duration-150" type="button">ADD USER</button>
